...
// .js-drop-menu - на само меню
// .drop-menu-icon - на иконку стрелки
...
export default function initDropDownMenu() {
	...
	const onClose = (btnElem, menuContainerElem, contentBtnHide, contentBtnOpen) => {
		...
		menuContainerElem.closest(".js-drop-menu-container-prent").classList.remove("mod-open");
	...
	const onOpen = (btnElem, menuContainerElem, menuElem, contentBtnHide, contentBtnOpen) => {
		...
		menuContainerElem.closest(".js-drop-menu-container-prent").classList.add('mod-open');;
